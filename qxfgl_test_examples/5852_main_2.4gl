...
#  Scope of the WHENEVER SQLERROR CALL sqlerror_handler_1 statement (see 5852_global_file_2.4gl module)
	DISPLAY "1. MAIN"
	SELECT * INTO glob_integer FROM table_does_not_exist --> This sql-error will be handled by the WHENEVER SQLERROR CALL sqlerror_handler_1 statement (see 5852_global_file_2.4gl module)
   ...
   CALL func_2() --> Inside the external func_2() function, the sql-error will be handled by the WHENEVER SQLERROR CALL sqlerror_handler_1 statement (see 5852_global_file_2.4gl module)
