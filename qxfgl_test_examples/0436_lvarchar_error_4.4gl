...
MAIN
   ...
   LET stmt = "INSERT INTO lyc_0436(col_lvarchar) VALUES(""",ins_lvarchar,""")"
   ...
   LET stmt = "SELECT col_lvarchar FROM lyc_0436 WHERE col_lvarchar = """,ins_lvarchar,""""
   PREPARE p_stmt_2 FROM stmt
   IF SQLCA.SQLCODE <> 0 THEN DISPLAY "3.  SQLCA.SQLCODE = ",SQLCA.SQLCODE END IF
   EXECUTE p_stmt_2 INTO sel_lvarchar
   ...
   DELETE FROM lyc_0436
   LET stmt = "INSERT INTO lyc_0436(col_lvarchar_1) VALUES(""",ins_lvarchar_1,""")"
   ...
   LET stmt = "SELECT col_lvarchar_1 FROM lyc_0436 WHERE col_lvarchar_1 = """,ins_lvarchar_1,""""
   PREPARE p_stmt_4 FROM stmt
   IF SQLCA.SQLCODE <> 0 THEN DISPLAY "8.  SQLCA.SQLCODE = ",SQLCA.SQLCODE END IF
   EXECUTE p_stmt_4 INTO sel_lvarchar_1
   ...
   END FOR      
   DELETE FROM lyc_0436
   LET stmt = "INSERT INTO lyc_0436(col_lvarchar_8000) VALUES(""",ins_lvarchar_8000,""")"
   ...
   LET stmt = "SELECT col_lvarchar_8000 FROM lyc_0436 WHERE col_lvarchar_8000 = """,ins_lvarchar_8000,""""
   PREPARE p_stmt_6 FROM stmt
   IF SQLCA.SQLCODE <> 0 THEN DISPLAY "13. SQLCA.SQLCODE = ",SQLCA.SQLCODE END IF
   EXECUTE p_stmt_6 INTO sel_lvarchar_8000
   IF SQLCA.SQLCODE <> 0 THEN DISPLAY "14. SQLCA.SQLCODE = ",SQLCA.SQLCODE END IF
   IF sel_lvarchar_8000       IS NULL   THEN DISPLAY "15. NULL"   ELSE DISPLAY "15. |",sel_lvarchar_8000,"|"   END IF
