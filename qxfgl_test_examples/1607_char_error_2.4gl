...
--      ins_char_8000, sel_char_8000  CHAR(2656),  --> error -999 doesn't appear
   ...
   FOR i = 1 TO 16
      LET ins_char_8000 = ins_char_8000 CLIPPED,"ääääääääääääääääääääääääääääääääääääääääääääääääääääääääääääääääääääääääääääääääääääääääääääääääääääääääääääääääääääääääääääääääääääääääääääääääääääääääääääääääääääääääääääääääääääääääääääääääääääääääääääääääääääääääääääääääääääääääääääääääääääääääää"
   END FOR      
