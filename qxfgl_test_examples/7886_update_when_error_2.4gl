...
MAIN
   ...
   DROP TABLE lyc_7886_update_when_error_2
   CREATE TABLE lyc_7886_update_when_error_2
   (row_number INTEGER,
    col_char CHAR(80)
   )

   INSERT INTO lyc_7886_update_when_error_2 VALUES(1,"1st row")
   INSERT INTO lyc_7886_update_when_error_2 VALUES(2,"2nd row")
   INSERT INTO lyc_7886_update_when_error_2 VALUES(3,"3rd row")
   INSERT INTO lyc_7886_update_when_error_2 VALUES(4,"4th row")
   INSERT INTO lyc_7886_update_when_error_2 VALUES(5,"5th row")
   IF SQLCA.SQLCODE <> 0 THEN DISPLAY "1. SQLCA.SQLCODE = ",SQLCA.SQLCODE EXIT PROGRAM END IF

   DECLARE cursor_1 CURSOR FOR 
   	SELECT row_number,col_char FROM lyc_7886_update_when_error_2 ORDER BY row_number

	UPDATE lyc_7886_update_when_error_2 SET col_char = (CASE WHEN row_number = 1 THEN "1st row updated 1" ELSE "NULL" END) WHERE row_number = 1
   IF SQLCA.SQLCODE <> 0 THEN DISPLAY "2. SQLCA.SQLCODE = ",SQLCA.SQLCODE END IF
	SELECT col_char INTO v_char FROM lyc_7886_update_when_error_2 WHERE row_number = 1
   IF SQLCA.SQLCODE <> 0 THEN DISPLAY "3. SQLCA.SQLCODE = ",SQLCA.SQLCODE ELSE DISPLAY "3. ",v_char END IF

	UPDATE lyc_7886_update_when_error_2 SET col_char = CASE WHEN row_number = 1 THEN "1st row updated 2" ELSE "NULL" END WHERE row_number = 5
   IF SQLCA.SQLCODE <> 0 THEN DISPLAY "4. SQLCA.SQLCODE = ",SQLCA.SQLCODE END IF
	SELECT col_char INTO v_char FROM lyc_7886_update_when_error_2 WHERE row_number = 5
   IF SQLCA.SQLCODE <> 0 THEN DISPLAY "5. SQLCA.SQLCODE = ",SQLCA.SQLCODE ELSE DISPLAY "5. ",v_char END IF

	UPDATE lyc_7886_update_when_error_2 SET col_char = 
   ...
   END FOREACH
	...
	LET v_int_init = 1 
	UPDATE lyc_7886_update_when_error_2 SET col_char = (CASE WHEN v_int_init = 1 THEN "1st row updated 9" ELSE "NULL" END) WHERE row_number = 1
   ...
   IF SQLCA.SQLCODE <> 0 THEN DISPLAY "19. SQLCA.SQLCODE = ",SQLCA.SQLCODE ELSE DISPLAY "19. ",v_char END IF
	...
	UPDATE lyc_7886_update_when_error_2 SET col_char = CASE WHEN v_int_init = 5 THEN "1st row updated 10" ELSE "NULL" END WHERE row_number = 5 
