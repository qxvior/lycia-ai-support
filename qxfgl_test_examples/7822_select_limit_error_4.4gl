...
MAIN
   ...
   DROP TABLE lyc_7822_select_limit_error_4
   CREATE TABLE lyc_7822_select_limit_error_4
   (row_number INTEGER,
    col_char CHAR(80)
   )

   INSERT INTO lyc_7822_select_limit_error_4 VALUES(1,"1st row")
   INSERT INTO lyc_7822_select_limit_error_4 VALUES(2,"2nd row")
   INSERT INTO lyc_7822_select_limit_error_4 VALUES(3,"3rd row")
   INSERT INTO lyc_7822_select_limit_error_4 VALUES(4,"4th row")
   INSERT INTO lyc_7822_select_limit_error_4 VALUES(5,"5th row")
   IF SQLCA.SQLCODE <> 0 THEN DISPLAY "1. SQLCA.SQLCODE = ",SQLCA.SQLCODE EXIT PROGRAM END IF

   SELECT LIMIT 1 * INTO rec_limit.* FROM lyc_7822_select_limit_error_4 ORDER BY row_number
   IF SQLCA.SQLCODE <> 0 THEN DISPLAY "2. SQLCA.SQLCODE = ",SQLCA.SQLCODE ELSE DISPLAY "2. ", rec_limit.v_row_number,"  ",rec_limit.v_char END IF
	...
	SELECT LIMIT 10 * INTO rec_limit.* FROM lyc_7822_select_limit_error_4 WHERE row_number = 5 
   ...
   SELECT LIMIT 2 * INTO rec_limit.* FROM lyc_7822_select_limit_error_4 ORDER BY row_number
   ...
   DECLARE cursor_1 CURSOR FOR SELECT LIMIT 1 * FROM lyc_7822_select_limit_error_4 ORDER BY row_number
   ...
   DECLARE cursor_2 CURSOR FOR SELECT LIMIT 10 * FROM lyc_7822_select_limit_error_4 WHERE row_number = 5
   ...
   DECLARE cursor_3 CURSOR FOR SELECT LIMIT 2 * FROM lyc_7822_select_limit_error_4 ORDER BY row_number
   ...
   DECLARE cursor_4 CURSOR FOR SELECT LIMIT 5 * FROM lyc_7822_select_limit_error_4 ORDER BY row_number
   ...
   DECLARE cursor_5 CURSOR FOR SELECT LIMIT 10 * FROM lyc_7822_select_limit_error_4 ORDER BY row_number
