...
MAIN
   ...
   LET stmt = "INSERT INTO lyc_0692(col_interval_y_y) VALUES(""",ins_interval_y_y,""")"
   ...
   LET stmt = "SELECT col_interval_y_y FROM lyc_0692 WHERE col_interval_y_y = """,ins_interval_y_y,""""
   PREPARE p_stmt_2 FROM stmt
   IF SQLCA.SQLCODE <> 0 THEN DISPLAY "3.  SQLCA.SQLCODE = ",SQLCA.SQLCODE END IF
   EXECUTE p_stmt_2 INTO sel_interval_y_y
   ...
   LET stmt = "INSERT INTO lyc_0692(col_interval_y_mo) VALUES(""",ins_interval_y_mo,""")"
   ...
   LET stmt = "SELECT col_interval_y_mo FROM lyc_0692 WHERE col_interval_y_mo = """,ins_interval_y_mo,""""
   PREPARE p_stmt_4 FROM stmt
   IF SQLCA.SQLCODE <> 0 THEN DISPLAY "8.  SQLCA.SQLCODE = ",SQLCA.SQLCODE END IF
   EXECUTE p_stmt_4 INTO sel_interval_y_mo
   ...
   LET stmt = "INSERT INTO lyc_0692(col_interval_mo_mo) VALUES(""",ins_interval_mo_mo,""")"
   ...
   LET stmt = "SELECT col_interval_mo_mo FROM lyc_0692 WHERE col_interval_mo_mo = """,ins_interval_mo_mo,""""
   PREPARE p_stmt_6 FROM stmt
   IF SQLCA.SQLCODE <> 0 THEN DISPLAY "13. SQLCA.SQLCODE = ",SQLCA.SQLCODE END IF
   EXECUTE p_stmt_6 INTO sel_interval_mo_mo
   ...
   LET stmt = "INSERT INTO lyc_0692(col_interval_d_d) VALUES(""",ins_interval_d_d,""")"
   ...
   LET stmt = "SELECT col_interval_d_d FROM lyc_0692 WHERE col_interval_d_d = """,ins_interval_d_d,""""
   PREPARE p_stmt_8 FROM stmt
   IF SQLCA.SQLCODE <> 0 THEN DISPLAY "18. SQLCA.SQLCODE = ",SQLCA.SQLCODE END IF
   EXECUTE p_stmt_8 INTO sel_interval_d_d
   ...
   LET stmt = "INSERT INTO lyc_0692(col_interval_d9_h) VALUES(""",ins_interval_d9_h,""")"
   ...
   LET stmt = "SELECT col_interval_d9_h FROM lyc_0692 WHERE col_interval_d9_h = """,ins_interval_d9_h,""""
   PREPARE p_stmt_10 FROM stmt
   IF SQLCA.SQLCODE <> 0 THEN DISPLAY "23. SQLCA.SQLCODE = ",SQLCA.SQLCODE END IF
   EXECUTE p_stmt_10 INTO sel_interval_d9_h
   ...
   LET stmt = "INSERT INTO lyc_0692(col_interval_d_mi) VALUES(""",ins_interval_d_mi,""")"
   ...
   LET stmt = "SELECT col_interval_d_mi FROM lyc_0692 WHERE col_interval_d_mi = """,ins_interval_d_mi,""""
   PREPARE p_stmt_12 FROM stmt
   IF SQLCA.SQLCODE <> 0 THEN DISPLAY "28. SQLCA.SQLCODE = ",SQLCA.SQLCODE END IF
   EXECUTE p_stmt_12 INTO sel_interval_d_mi
   ...
   LET stmt = "INSERT INTO lyc_0692(col_interval_d9_s) VALUES(""",ins_interval_d9_s,""")"
   ...
   LET stmt = "SELECT col_interval_d9_s FROM lyc_0692 WHERE col_interval_d9_s = """,ins_interval_d9_s,""""
   PREPARE p_stmt_14 FROM stmt
   IF SQLCA.SQLCODE <> 0 THEN DISPLAY "33. SQLCA.SQLCODE = ",SQLCA.SQLCODE END IF
   EXECUTE p_stmt_14 INTO sel_interval_d9_s
   ...
   LET stmt = "INSERT INTO lyc_0692(col_interval_d_f) VALUES(""",ins_interval_d_f,""")"
   ...
   LET stmt = "SELECT col_interval_d_f FROM lyc_0692 WHERE col_interval_d_f = """,ins_interval_d_f,""""
   PREPARE p_stmt_16 FROM stmt
   IF SQLCA.SQLCODE <> 0 THEN DISPLAY "38. SQLCA.SQLCODE = ",SQLCA.SQLCODE END IF
   EXECUTE p_stmt_16 INTO sel_interval_d_f
   ...
   LET stmt = "INSERT INTO lyc_0692(col_interval_h_h) VALUES(""",ins_interval_h_h,""")"
   PREPARE p_stmt_17 FROM stmt
   IF SQLCA.SQLCODE <> 0 THEN DISPLAY "36. SQLCA.SQLCODE = ",SQLCA.SQLCODE END IF
   EXECUTE p_stmt_17
   IF SQLCA.SQLCODE <> 0 THEN DISPLAY "37. SQLCA.SQLCODE = ",SQLCA.SQLCODE END IF
   LET sel_interval_h_h = NULL
   LET stmt = "SELECT col_interval_h_h FROM lyc_0692 WHERE col_interval_h_h = """,ins_interval_h_h,""""
   PREPARE p_stmt_18 FROM stmt
   IF SQLCA.SQLCODE <> 0 THEN DISPLAY "38. SQLCA.SQLCODE = ",SQLCA.SQLCODE END IF
   EXECUTE p_stmt_18 INTO sel_interval_h_h
   IF SQLCA.SQLCODE <> 0 THEN DISPLAY "39. SQLCA.SQLCODE = ",SQLCA.SQLCODE END IF
   ...
   LET stmt = "INSERT INTO lyc_0692(col_interval_h9_mi) VALUES(""",ins_interval_h9_mi,""")"
   ...
   LET stmt = "SELECT col_interval_h9_mi FROM lyc_0692 WHERE col_interval_h9_mi = """,ins_interval_h9_mi,""""
   PREPARE p_stmt_20 FROM stmt
   IF SQLCA.SQLCODE <> 0 THEN DISPLAY "43. SQLCA.SQLCODE = ",SQLCA.SQLCODE END IF
   EXECUTE p_stmt_20 INTO sel_interval_h9_mi
   ...
   LET stmt = "INSERT INTO lyc_0692(col_interval_h_s) VALUES(""",ins_interval_h_s,""")"
   ...
   LET stmt = "SELECT col_interval_h_s FROM lyc_0692 WHERE col_interval_h_s = """,ins_interval_h_s,""""
   PREPARE p_stmt_22 FROM stmt
   IF SQLCA.SQLCODE <> 0 THEN DISPLAY "48. SQLCA.SQLCODE = ",SQLCA.SQLCODE END IF
   EXECUTE p_stmt_22 INTO sel_interval_h_s
   ...
   LET stmt = "INSERT INTO lyc_0692(col_interval_h9_f) VALUES(""",ins_interval_h9_f,""")"
   ...
   LET stmt = "SELECT col_interval_h9_f FROM lyc_0692 WHERE col_interval_h9_f = """,ins_interval_h9_f,""""
   PREPARE p_stmt_24 FROM stmt
   IF SQLCA.SQLCODE <> 0 THEN DISPLAY "53. SQLCA.SQLCODE = ",SQLCA.SQLCODE END IF
   EXECUTE p_stmt_24 INTO sel_interval_h9_f
