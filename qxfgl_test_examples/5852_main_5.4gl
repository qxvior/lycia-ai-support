...
##############################################################################################################
GLOBALS "5852_global_file_5.4gl"
MAIN

#  Scope of the WHENEVER ANY ERROR CALL error_handler_1 statement (see 5852_global_file_5.4gl module)
	DISPLAY "1. MAIN"
	LET glob_integer = "abc" --> This error will be handled by the WHENEVER ANY ERROR CALL error_handler_1 statement  (see 5852_global_file_5.4gl module)
   ...
   CALL func_2() --> Inside the external func_2() function, the error will be handled by the WHENEVER ANY ERROR CALL error_handler_1 statement (see 5852_global_file_5.4gl module)
   CALL func_3() --> Inside the external func_3() function, the error will be handled by the WHENEVER ERROR CONTINUE statement (see 5852_global_file_5.4gl module)
	DISPLAY "2. MAIN"
	LET glob_integer = "abc" --> This error will be handled by the WHENEVER ANY ERROR CALL error_handler_1 statement (see 5852_global_file_5.4gl module)
