...
MAIN
   ...
   DROP TABLE lyc_7822_select_limit_error_1
   CREATE TABLE lyc_7822_select_limit_error_1
   (row_number INTEGER,
    col_char CHAR(80)
   )

   INSERT INTO lyc_7822_select_limit_error_1 VALUES(1,"1st row")
   INSERT INTO lyc_7822_select_limit_error_1 VALUES(2,"2nd row")
   INSERT INTO lyc_7822_select_limit_error_1 VALUES(3,"3rd row")
   INSERT INTO lyc_7822_select_limit_error_1 VALUES(4,"4th row")
   INSERT INTO lyc_7822_select_limit_error_1 VALUES(5,"5th row")
   IF SQLCA.SQLCODE <> 0 THEN DISPLAY "1. SQLCA.SQLCODE = ",SQLCA.SQLCODE EXIT PROGRAM END IF

   PREPARE p_select FROM "SELECT LIMIT 1 row_number, col_char FROM lyc_7822_select_limit_error_1 ORDER BY row_number"
   ...
   PREPARE p_select FROM "SELECT LIMIT 10 row_number, col_char FROM lyc_7822_select_limit_error_1 WHERE row_number = 5"
   EXECUTE p_select INTO v_row_number,v_char
   IF SQLCA.SQLCODE <> 0 THEN DISPLAY "3. SQLCA.SQLCODE = ",SQLCA.SQLCODE ELSE DISPLAY "3. ", v_row_number,"  ",v_char END IF

   PREPARE p_select FROM "SELECT LIMIT 2 row_number, col_char FROM lyc_7822_select_limit_error_1 ORDER BY row_number"
   EXECUTE p_select INTO v_row_number,v_char
   ...
   PREPARE p_select FROM "SELECT LIMIT 5 row_number, col_char FROM lyc_7822_select_limit_error_1 ORDER BY row_number"
   ...
   PREPARE p_select FROM "SELECT LIMIT 10 row_number, col_char FROM lyc_7822_select_limit_error_1 ORDER BY row_number"
