...
MAIN
   ...
   END FOR      
   INSERT INTO lyc_0436(col_lvarchar) VALUES(ins_lvarchar)
   IF SQLCA.SQLCODE <> 0 THEN DISPLAY "1.  SQLCA.SQLCODE = ",SQLCA.SQLCODE END IF
   LET sel_lvarchar = NULL
   SELECT col_lvarchar INTO sel_lvarchar FROM lyc_0436 WHERE col_lvarchar = ins_lvarchar
   ...
   INSERT INTO lyc_0436(col_lvarchar_1) VALUES(ins_lvarchar_1)
   IF SQLCA.SQLCODE <> 0 THEN DISPLAY "4.  SQLCA.SQLCODE = ",SQLCA.SQLCODE END IF
   LET sel_lvarchar_1 = NULL
   SELECT col_lvarchar_1 INTO sel_lvarchar_1 FROM lyc_0436 WHERE col_lvarchar_1 = ins_lvarchar_1
   ...
   END FOR      
   DELETE FROM lyc_0436
   INSERT INTO lyc_0436(col_lvarchar_8000) VALUES(ins_lvarchar_8000)
   IF SQLCA.SQLCODE <> 0 THEN DISPLAY "7.  SQLCA.SQLCODE = ",SQLCA.SQLCODE END IF
   LET sel_lvarchar_8000 = NULL
   SELECT col_lvarchar_8000 INTO sel_lvarchar_8000 FROM lyc_0436 WHERE col_lvarchar_8000 = ins_lvarchar_8000
