...
MAIN
   ...
   INSERT INTO lyc_0694(col_interval_mi_mi) VALUES(ins_interval_mi_mi)
   IF SQLCA.SQLCODE <> 0 THEN DISPLAY "37. SQLCA.SQLCODE = ",SQLCA.SQLCODE END IF
   LET sel_interval_mi_mi = NULL
   SELECT col_interval_mi_mi INTO sel_interval_mi_mi FROM lyc_0694 WHERE col_interval_mi_mi = ins_interval_mi_mi
   ...
   INSERT INTO lyc_0694(col_interval_mi9_s) VALUES(ins_interval_mi9_s)
   IF SQLCA.SQLCODE <> 0 THEN DISPLAY "40. SQLCA.SQLCODE = ",SQLCA.SQLCODE END IF
   LET sel_interval_mi9_s = NULL
   SELECT col_interval_mi9_s INTO sel_interval_mi9_s FROM lyc_0694 WHERE col_interval_mi9_s = ins_interval_mi9_s
   ...
   INSERT INTO lyc_0694(col_interval_mi_f) VALUES(ins_interval_mi_f)
   IF SQLCA.SQLCODE <> 0 THEN DISPLAY "43. SQLCA.SQLCODE = ",SQLCA.SQLCODE END IF
   LET sel_interval_mi_f = NULL
   SELECT col_interval_mi_f INTO sel_interval_mi_f FROM lyc_0694 WHERE col_interval_mi_f = ins_interval_mi_f
   ...
   INSERT INTO lyc_0694(col_interval_s_s) VALUES(ins_interval_s_s)
   IF SQLCA.SQLCODE <> 0 THEN DISPLAY "46. SQLCA.SQLCODE = ",SQLCA.SQLCODE END IF
   LET sel_interval_s_s = NULL
   SELECT col_interval_s_s INTO sel_interval_s_s FROM lyc_0694 WHERE col_interval_s_s = ins_interval_s_s
   ...
   INSERT INTO lyc_0694(col_interval_s9_f) VALUES(ins_interval_s9_f)
   IF SQLCA.SQLCODE <> 0 THEN DISPLAY "49. SQLCA.SQLCODE = ",SQLCA.SQLCODE END IF
   LET sel_interval_s9_f = NULL
   SELECT col_interval_s9_f INTO sel_interval_s9_f FROM lyc_0694 WHERE col_interval_s9_f = ins_interval_s9_f
   ...
   INSERT INTO lyc_0694(col_interval_f_f) VALUES(ins_interval_f_f)
   IF SQLCA.SQLCODE <> 0 THEN DISPLAY "53. SQLCA.SQLCODE = ",SQLCA.SQLCODE END IF
   LET sel_interval_f_f = NULL
   SELECT col_interval_f_f INTO sel_interval_f_f FROM lyc_0694 WHERE col_interval_f_f = ins_interval_f_f
