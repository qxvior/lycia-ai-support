...
MAIN
	...
	OPEN WINDOW wContact WITH FORM "form/cnt_table_input_array_mixed_widgets2"
	CALL ui.Interface.setText("DispArr2")
	DISPLAY "DISPLAY ARRAY with mixed widgets - Demo 2" TO lbTitle
	...
	#----------------------------------------------------------------------------------
	DISPLAY ARRAY arrRec_contactMorphed TO scr_contact2.* ATTRIBUTE(UNBUFFERED)
		BEFORE DISPLAY  --Let's hide the table navigation in this example
