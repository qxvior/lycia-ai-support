...
define gparam record --veta pre vyber parametrov
        id       like kalkul:zk_paramoper.id ,
        datplat          like kalkul:zk_paramoper.datplat ,
        podv     like kalkul:zk_paramoper.podv ,
        cov      like kalkul:zk_paramoper.cov ,
        kodsps   like kalkul:zk_paramoper.kodsps ,
        csv      like kalkul:zk_paramoper.csv ,
        cisoper          like kalkul:zk_paramoper.cisoper ,
        gramod   like kalkul:zk_paramoper.gramod ,
        gramdo   like kalkul:zk_paramoper.gramdo ,
        hrubkaod         like kalkul:zk_paramoper.hrubkaod ,
        hrubkado         like kalkul:zk_paramoper.hrubkado ,
        rychlost         like kalkul:zk_paramoper.rychlost ,
        mjrychlost       like kalkul:zk_paramoper.mjrychlost ,
        casmontazzak     like kalkul:zk_paramoper.casmontazzak ,
        casmontazfar     like kalkul:zk_paramoper.casmontazfar ,
        caszabehzak      like kalkul:zk_paramoper.caszabehzak ,
        caszabehfar      like kalkul:zk_paramoper.caszabehfar ,
        casmiesaniezak   like kalkul:zk_paramoper.casmiesaniezak ,
        casmiesaniefar   like kalkul:zk_paramoper.casmiesaniefar ,
        casdemontazzak   like kalkul:zk_paramoper.casdemontazzak ,
        casdemontazfar   like kalkul:zk_paramoper.casdemontazfar ,
        cascisteniezak   like kalkul:zk_paramoper.cascisteniezak ,
        cascisteniefar   like kalkul:zk_paramoper.cascisteniefar ,
        casbobinabm      like kalkul:zk_paramoper.casbobinabm ,
        casubehmin       like kalkul:zk_paramoper.casubehmin ,
        casnaobsluhu     like kalkul:zk_paramoper.casnaobsluhu ,
        percodpad        like kalkul:zk_paramoper.percodpad ,
        pridavokmaterzak like kalkul:zk_paramoper.pridavokmaterzak ,
        pridavokmaterzfar  like kalkul:zk_paramoper.pridavokmaterzfar ,
        pobobinabm       like kalkul:zk_paramoper.pobobinabm ,
        pridavokbehbm    like kalkul:zk_paramoper.pridavokbehbm ,
        pridavokfarby    like kalkul:zk_paramoper.pridavokfarby ,
        liehnaumytie     like kalkul:zk_paramoper.liehnaumytie ,
        ckpolprip1       like kalkul:zk_paramoper.ckpolprip1 ,
        ckpolprip2       like kalkul:zk_paramoper.ckpolprip2 ,
        ckpolprip3       like kalkul:zk_paramoper.ckpolprip3 ,
        ckpolbeh1        like kalkul:zk_paramoper.ckpolbeh1 ,
        ckpolbeh2        like kalkul:zk_paramoper.ckpolbeh2 ,
        ckpolbeh3        like kalkul:zk_paramoper.ckpolbeh3 ,
        sadzbaprip1      like kalkul:zk_paramoper.sadzbaprip1 ,
        sadzbaprip2      like kalkul:zk_paramoper.sadzbaprip2 ,
        sadzbaprip3      like kalkul:zk_paramoper.sadzbaprip3 ,
        sadzbabeh1       like kalkul:zk_paramoper.sadzbabeh1 ,
        sadzbabeh2       like kalkul:zk_paramoper.sadzbabeh2 ,
        sadzbabeh3       like kalkul:zk_paramoper.sadzbabeh3 ,
        poznamka         like kalkul:zk_paramoper.poznamka ,
        novecsv          like kalkul:sort.novecsv ,
        ckpolprip4       like kalkul:zk_paramoper.ckpolprip4 ,
        ckpolprip5       like kalkul:zk_paramoper.ckpolprip5 ,
        ckpolprip6       like kalkul:zk_paramoper.ckpolprip6 ,
        ckpolbeh4        like kalkul:zk_paramoper.ckpolbeh4 ,
        ckpolbeh5        like kalkul:zk_paramoper.ckpolbeh5 ,
        ckpolbeh6        like kalkul:zk_paramoper.ckpolbeh6 ,
        sadzbaprip4      like kalkul:zk_paramoper.sadzbaprip4 ,
        sadzbaprip5      like kalkul:zk_paramoper.sadzbaprip5 ,
        sadzbaprip6      like kalkul:zk_paramoper.sadzbaprip6 ,
        sadzbabeh4       like kalkul:zk_paramoper.sadzbabeh4 ,
        sadzbabeh5       like kalkul:zk_paramoper.sadzbabeh5 ,
        sadzbabeh6       like kalkul:zk_paramoper.sadzbabeh6
 end record
}
...
{
define pp_18 record 
		id 	 like pl_dostup_zdroja.id ,
		idpl_poziad_progn 	 like pl_dostup_zdroja.idpl_poziad_progn ,
		idpl_vyuz_zdroj 	 like pl_dostup_zdroja.idpl_vyuz_zdroj ,
		verzia 	 like pl_dostup_zdroja.verzia ,
		platnost 	 like pl_dostup_zdroja.platnost ,
		cpv 	 like pl_vyuz_zdroj.cpv ,
		cov 	 like pl_vyuz_zdroj.cov ,
		coo 	 like vp_polot.cov ,
		datplat 	 like pl_vyuz_zdroj.datplat ,
		csv 	 like pl_vyuz_zdroj.csv ,
		ckpol 	 like pl_vyuz_zdroj.ckpol ,
		idsh_material 	 like pl_vyuz_zdroj.idsh_material ,
		cissklad 	 like is_1:sh_material.cissklad ,
		evidcis 	 like is_1:sh_material.evidcis ,
		nazovmat 	 like is_1:sh_material.nazovmat ,
		termin_dodania 	 like pl_dostup_zdroja.termin_dodania ,
		c_potv 	 like pl_dostup_zdroja.c_potv ,
		idpotvrdil 	 like pl_dostup_zdroja.idpotvrdil ,
		priezvisko 	 CHAR(50) ,
		meno 	 CHAR(20) ,
		sirka 	 like pl_vyuz_zdroj.sirka ,
		gram 	 like pl_vyuz_zdroj.gram ,
		mikron 	 like pl_vyuz_zdroj.mikron ,
		mnoz_kg 	 like pl_vyuz_zdroj.mnoz_kg ,
		mnoz_mj 	 like pl_vyuz_zdroj.mnoz_mj ,
		mj 	 like pl_vyuz_zdroj.mj ,
		nahrad 	 like kalkul:kalpol.nahrad ,
		nazov 	 CHAR(35) ,
		idpl_sledpolozka 	 like pl_vyuz_zdroj.idpl_sledpolozka ,
		idpl_typzdroja 	 like pl_vyuz_zdroj.idpl_typzdroja ,
		sirka_gener 	 like pl_vyuz_zdroj.sirka_gener ,
		mnoz_kg_gener 	 like pl_vyuz_zdroj.mnoz_kg_gener ,
		mnoz_mj_gener 	 like pl_vyuz_zdroj.mnoz_mj_gener ,
		gener 	 like pl_vyuz_zdroj.gener ,
		termin_poz_uv 	 like pl_poziad_progn.termin_poz_uv ,
		cso 	 like vp_polot.csv ,
		kod_oper 	 like pl_oper.kod_oper ,
		sirka_odober 	 like vp_polot.sirka ,
		mnoz_m2_odober 	 like vp_polot.mnoz_m2_vst ,
		vrstva 	 like pl_vyuz_zdroj.vrstva ,
		tlacena_vrstva 	 CHAR(1) 
	 end record 
##@@18
##@@03
define pp_03 record 
		id 	 like pl_paramstroj.id ,
		cpv 	 like pl_paramstroj.cpv ,
		cov 	 like pl_paramstroj.cov ,
		cstroj 	 like pl_paramstroj.cstroj ,
		nazstroja 	 like polot:po_stroje.nazstroja ,
		idpo_stroje 	 like pl_paramstroj.idpo_stroje ,
		idzmenil 	 like pl_paramstroj.idzmenil ,
		...
		rychlost_unikod 	 like pl_paramstroj.rychlost_unikod ,
		mjrychlost_unikod 	 like pl_paramstroj.mjrychlost_unikod ,
		...
		priezvisko 	 CHAR(50) ,
		meno 	 CHAR(20) ,
		c_zmeny 	 like pl_paramstroj.c_zmeny 
	 end record 
##@@03
##@@14
define pp_14 record 
		id 	 like pl_poziad_progn.id ,
		ckz 	 like pl_poziad_progn.ckz ,
		porc 	 like pl_poziad_progn.porc ,
		stav 	 like pl_poziad_progn.stav ,
		status_gen_vp 	 like pl_poziad_progn.status_gen_vp ,
		stav_terminy 	 CHAR(1) ,
		pr_ziada_term 	 like pl_poziad_progn.pr_ziada_term ,
		idkzmluvy 	 like pl_poziad_progn.idkzmluvy ,
		idkpolozky 	 like pl_poziad_progn.idkpolozky ,
		cislo_vp 	 like pl_poziad_progn.cislo_vp ,
		idv_prikazy 	 like pl_poziad_progn.idv_prikazy ,
		termin_poz_uv 	 like pl_poziad_progn.termin_poz_uv ,
		termin_prog_uv 	 like pl_poziad_progn.termin_prog_uv ,
		nazof 	 like v_prikazy.nazof ,
		pozn_predaja 	 CHAR(1) ,
		sirka 	 like v_prikazy.sirka ,
		csort 	 like v_prikazy.csort ,
		nazsort 	 like v_prikazy.nazsort ,
		gram 	 like vyrobky:fivy.gram ,
		mikron 	 like vyrobky:fivy.mikron ,
		...
		oznac 	 like v_prikazy.oznac ,
		d_poziad 	 like pl_poziad_progn.d_poziad ,
		c_poziad 	 like pl_poziad_progn.c_poziad ,
		idpozadoval 	 like pl_poziad_progn.idpozadoval ,
		priezvisko 	 CHAR(50) ,
		meno 	 CHAR(20) ,
		d_prognoz 	 like pl_poziad_progn.d_prognoz ,
		c_prognoz 	 like pl_poziad_progn.c_prognoz ,
		idprognozoval 	 like pl_poziad_progn.idprognozoval ,
		priez_prog 	 CHAR(50) ,
		meno_prog 	 CHAR(20) ,
		d_potvrdenia 	 like pl_poziad_progn.d_potvrdenia ,
		c_potvrdenia 	 like pl_poziad_progn.c_potvrdenia ,
		idpotvrdil 	 like pl_poziad_progn.idpotvrdil ,
		priez_potv 	 CHAR(50) ,
		meno_potv 	 CHAR(20) ,
		d_poziad_stor 	 like pl_poziad_progn.d_poziad_stor ,
		c_poziad_stor 	 like pl_poziad_progn.c_poziad_stor ,
		idpoziad_stor 	 like pl_poziad_progn.idpoziad_stor ,
		priez_stor 	 CHAR(50) ,
		meno_stor 	 CHAR(20) ,
		d_uplynutia 	 like pl_poziad_progn.d_uplynutia ,
		c_uplynutia 	 like pl_poziad_progn.c_uplynutia ,
		d_akceptacie 	 like pl_poziad_progn.d_akceptacie ,
		c_akceptacie 	 like pl_poziad_progn.c_akceptacie ,
		idakceptoval 	 like pl_poziad_progn.idakceptoval ,
		priez_akcept 	 CHAR(50) ,
		meno_akcept 	 CHAR(20) ,
		kod_gfp_1st 	 like k_zmluvy:kpolozky.kod_gfp_1st ,
		kod_storna 	 like k_zmluvy:kpolozky.kod_storna ,
		stav_prik 	 like v_prikazy.stav_prik ,
		ins_dostup_zdr 	 like pl_poziad_progn.ins_dostup_zdr ,
		pozn 	 like k_zmluvy:poznamky.pozn ,
		pozn_log 	 like k_zmluvy:poznamky.pozn ,
		verzia_vp 	 like v_prikazy.verzia ,
		verzia 	 like pl_poziad_progn.verzia ,
		ukonc_gfp 	 like v_prikazy.ukonc_gfp ,
		termin_prog_uv_s 	 like pl_poziad_progn.termin_prog_uv_s ,
		vzorka 	 like v_prikazy.vzorka ,
		pcrefv 	 like v_prikazy.pcrefv ,
		podv 	 like v_prikazy.podv ,
		c_odosl_na_logist 	 like pl_poziad_progn.c_odosl_na_logist ,
		idodosl_na_logist 	 like pl_poziad_progn.idodosl_na_logist ,
		priez_logist 	 CHAR(50) ,
		meno_logist 	 CHAR(20) ,
		varianta 	 like v_prikazy.varianta ,
		zl_laky_szvar 	 like v_prikazy.zl_laky_szvar ,
		kodvyvoja 	 like v_prikazy.kodvyvoja ,
		archiv 	 CHAR(1) ,
		typ_vynimky 	 CHAR(1) ,
		typ_vynimky_popis 	 CHAR(13) ,
		termin_vynimky 	 DATE ,
		termin_zmluv_uv 	 like pl_poziad_progn.termin_zmluv_uv ,
		termin_prog_natlac 	 like pl_poziad_progn.termin_prog_natlac ,
		tlac1 	 like pl_poziad_progn.tlac1 ,
		c_suhlasil_sirky 	 like pl_poziad_progn.c_suhlasil_sirky ,
		idsuhlasil_sirky 	 like pl_poziad_progn.idsuhlasil_sirky ,
...
##@@02
define pp_02 record 
		id 	 like pl_dobyzrenia.id ,
		cpv 	 like pl_dobyzrenia.cpv ,
		csv 	 like pl_dobyzrenia.csv ,
		nazov 	 like kalkul:sort.nazov ,
		ctoper 	 like pl_dobyzrenia.ctoper ,
		cisoper 	 like pl_tech_zl.cisoper ,
		nazoper 	 like pl_oper.nazoper ,
		platnostod 	 like pl_dobyzrenia.platnostod ,
		platnostdo 	 like pl_dobyzrenia.platnostdo ,
		caszrenia 	 like pl_dobyzrenia.caszrenia ,
		techn_spracov 	 like pl_dobyzrenia.techn_spracov ,
		ctv 	 like tech_sort.ctv ,
		naztech 	 like technologie.naztech ,
		c_zmeny 	 like pl_dobyzrenia.c_zmeny ,
		idzmenil 	 like pl_dobyzrenia.idzmenil ,
		cov2 	 like kalkul:sort.cov ,
		priezvisko 	 CHAR(50) ,
		meno 	 CHAR(20) ,
		cov 	 like pl_dobyzrenia.cov ,
		coo 	 like pl_dobyzrenia.coo ,
		idfivy 	 like pl_dobyzrenia.idfivy 
	 end record 
##@@02
##@@46
define pp_46 record 
		id 	 like pl_rezerv_kapacita.id ,
		idpl_kalend_obd 	 like pl_rezerv_kapacita.idpl_kalend_obd ,
		cpv 	 like pl_rezerv_kapacita.cpv ,
		cov 	 like pl_rezerv_kapacita.cov ,
		obdobie 	 like pl_rezerv_kapacita.obdobie ,
		idpo_stroje 	 like pl_rezerv_kapacita.idpo_stroje ,
		cstroj 	 like polot:po_stroje.cstroj ,
		nazstroja 	 like polot:po_stroje.nazstroja ,
		idnad_spol1 	 like pl_rezerv_kapacita.idnad_spol1 ,
		snazf 	 like vyrobky:firma.snazf ,
		pref_tlac1 	 like exp_kalk:nad_spol1.pref_tlac1 ,
		rezerv_kapacita 	 like pl_rezerv_kapacita.rezerv_kapacita ,
		rez_kap_per 	 DEC(4,1) ,
		...
		platnost 	 like pl_rezerv_kapacita.platnost ,
		cas_zmeny 	 like pl_rezerv_kapacita.cas_zmeny ,
		priezvisko 	 CHAR(50) ,
		meno 	 CHAR(20) ,
		idzmenil 	 like pl_rezerv_kapacita.idzmenil 
	 end record 
##@@46
##@@59
define pp_59 record 
		id 	 like tp_hlavicka.id ,
		cpf 	 like tp_hlavicka.cpf ,
		csf 	 like tp_hlavicka.csf ,
		cof 	 like tp_hlavicka.cof ,
		nazov 	 like kalkul:sort.nazov ,
		popis 	 like kalkul:kodsort.popis ,
		varianta 	 like tp_hlavicka.varianta ,
		gramf 	 like tp_hlavicka.gramf ,
		mikronf 	 like tp_hlavicka.mikronf ,
		jemnostf 	 like tp_hlavicka.jemnostf ,
		idft_typzdruzf 	 like tp_hlavicka.idft_typzdruzf ,
		typ 	 like polot:ft_typzdruz.typ ,
		pocetfibrilf 	 like tp_hlavicka.pocetfibrilf ,
		idft_smerzakrutf 	 like tp_hlavicka.idft_smerzakrutf ,
		kod 	 like polot:ft_smerzakrut.kod ,
		skaci_zakrutf 	 like tp_hlavicka.skaci_zakrutf ,
		idfarbypopf 	 like tp_hlavicka.idfarbypopf ,
		kodfar 	 like vyrobky:farbypop.kodfar ,
		nazmelir 	 like vyrobky:farbypop.nazmelir ,
		idprofilvlf 	 like tp_hlavicka.idprofilvlf ,
		skratka 	 like vlakna:profilvl.skratka ,
		nazslov 	 like vlakna:profilvl.nazslov ,
		variant_vyroby 	 like tp_hlavicka.variant_vyroby ,
		platnost 	 like tp_hlavicka.platnost ,
		idzmenil 	 like tp_hlavicka.idzmenil ,
		cas_zmeny 	 like tp_hlavicka.cas_zmeny ,
		celemeno 	 CHAR(100) ,
		novecsv 	 like kalkul:sort.novecsv 
	 end record 
##@@59
...
define pp_55 record 
		...
		termin_poz_uv 	 like pl_poziad_progn.termin_poz_uv ,
		termin_prog_uv 	 like pl_poziad_progn.termin_prog_uv ,
		nazof 	 like vyrobky:firma.nazof ,
		pozn_predaja 	 CHAR(1) ,
		csv 	 like kalkul:sort.csv ,
		nazov 	 like kalkul:sort.nazov ,
		celkks 	 like vptab.celkks ,
		merjed 	 like vptab.merjed ,
		cref 	 like vptab.cref ,
		kodzmen 	 like vptab.kodzmen ,
		d_poziad 	 like pl_poziad_progn.d_poziad ,
		c_poziad 	 like pl_poziad_progn.c_poziad ,
		idpozadoval 	 like pl_poziad_progn.idpozadoval ,
		priezvisko 	 CHAR(50) ,
		...
		priez_akcept 	 CHAR(50) ,
		meno_akcept 	 CHAR(20) ,
		kod_storna 	 like vlakna:vpolozky.kod_storna ,
		stav_prik 	 like vptab.stav_prik ,
		ins_dostup_zdr 	 like pl_poziad_progn.ins_dostup_zdr ,
		pozn 	 like vlakna:poznamky.pozn ,
		pozn_log 	 like vlakna:poznamky.pozn ,
		verzia_vp 	 like vptab.verzia ,
		verzia 	 like pl_poziad_progn.verzia ,
		termin_prog_uv_s 	 like pl_poziad_progn.termin_prog_uv_s ,
		pcrefv 	 like vlakna:vpolozky.pcrefv ,
		podnik 	 like vptab.podnik ,
		c_odosl_na_logist 	 like pl_poziad_progn.c_odosl_na_logist ,
		idodosl_na_logist 	 like pl_poziad_progn.idodosl_na_logist ,
		priez_logist 	 CHAR(50) ,
		meno_logist 	 CHAR(20) ,
		kodvyvoja 	 like kalkul:sort.kodvyvoja ,
		typ_vynimky 	 CHAR(1) ,
		typ_vynimky_popis 	 CHAR(13) ,
		termin_vynimky 	 DATE ,
		termin_zmluv_uv 	 like pl_poziad_progn.termin_zmluv_uv ,
		...
		priez_suhlas_sirky 	 CHAR(50) ,
		meno_suhlas_sirky 	 CHAR(20) ,
		dtex_nazov 	 like vptab.dtex_nazov ,
		specifv 	 like vptab.specifv ,
		dtex_velkost 	 CHAR(20) ,
		farba 	 like vptab.farba ,
		menom 	 like vptab.menom ,
		mel_nazov 	 like vptab.mel_nazov ,
		melir_menovz 	 CHAR(15) ,
		nazovvyr 	 like vptab.nazovvyr ,
		kod 	 like polot:ft_smerzakrut.kod ,
		idvzmluvy 	 like pl_poziad_progn.idvzmluvy ,
		idvpolozky 	 like pl_poziad_progn.idvpolozky ,
		idvptab 	 like pl_poziad_progn.idvptab ,
		cpv 	 like pl_poziad_progn.cpv ,
		cpf 	 like pl_poziad_progn.cpf ,
		csf 	 like pl_poziad_progn.csf ,
		varianta 	 like pl_poziad_progn.varianta ,
		gramf 	 like pl_poziad_progn.gramf ,
		mikronf 	 like pl_poziad_progn.mikronf ,
		jemnostf 	 like pl_poziad_progn.jemnostf ,
		idft_typzdruzf 	 like pl_poziad_progn.idft_typzdruzf ,
		pocetfibrilf 	 like pl_poziad_progn.pocetfibrilf ,
		idft_smerzakrutf 	 like pl_poziad_progn.idft_smerzakrutf ,
		skaci_zakrutf 	 like pl_poziad_progn.skaci_zakrutf ,
		idfarbypopf 	 like pl_poziad_progn.idfarbypopf ,
		idprofilvlf 	 like pl_poziad_progn.idprofilvlf ,
		variant_vyroby 	 like pl_poziad_progn.variant_vyroby ,
		c_urcil_variant 	 like pl_poziad_progn.c_urcil_variant ,
		urcil_variant 	 like pl_poziad_progn.urcil_variant ,
...
##@@58
define pp_58 record 
		pod 	 like ciselniky:str.pod ,
		str 	 like ciselniky:str.str ,
		nazov 	 like ciselniky:str.nazov ,
		id 	 like polot:po_stroje.id ,
		cstroj 	 like polot:po_stroje.cstroj ,
		nazstroja 	 like polot:po_stroje.nazstroja 
	 end record 
##@@58
##@@57
define pp_57 record 
		id 	 like pl_rezerv_odd.id ,
		cpv 	 like pl_rezerv_odd.cpv ,
		cov 	 like pl_rezerv_odd.cov ,
		nazov 	 like ciselniky:str.nazov ,
		platnost 	 like pl_rezerv_odd.platnost ,
		cas_zmeny 	 like pl_rezerv_odd.cas_zmeny ,
		zmenil 	 like pl_rezerv_odd.zmenil ,
		celemeno 	 CHAR(100) 
	 end record 
##@@57
##@@56
define pp_56 record 
		...
		datpotv 	 like v_prikazy.datpotv ,
		mnozkg 	 like v_prikazy.mnozkg ,
		oznac 	 like v_prikazy.oznac ,
		snazf 	 like vyrobky:firma.snazf ,
		mnoz_kg 	 like vp_polot.mnoz_kg ,
		vyrkg 	 like polot:ht_vpvyr.vyrkg 
	 end record 
##@@56
##@@44
define pp_44 record 
		...
		d_plnenia 	 like vp_polot.d_plnenia ,
		suma_zdrojov 	 DEC(9,2) ,
		mnoz_kg 	 like vp_polot.mnoz_kg ,
		cstroj 	 like denne_plany.cstroj ,
		poradie 	 like denne_plany.poradie ,
		termin_zaciatku 	 DATETIME YEAR TO MINUTE ,
		pozn 	 like denne_plany.pozn ,
		vstup_polot 	 CHAR(1) ,
		idsh_material 	 like pl_vyuz_zdroj.idsh_material ,
		idvp_polot 	 like pl_sledpolozka.idvp_polot 
	 end record 
##@@44
##@@34
define pp_34 record 
		...
		datprijmu 	 DATE ,
		str 	 like polot:ht_skladprod.str ,
		kg 	 like polot:ht_skladprod.kg ,
		doba_skladovania 	 INTEGER ,
		sirka 	 like is_1:sh_popis.sirka 
	 end record 
##@@34
##@@19
define pp_19 record 
		...
		skupinakp 	 CHAR(15) ,
		sirka 	 like is_1:sh_popis.sirka ,
		hrubka 	 like is_1:sh_popis.hrubka ,
		nazovmat 	 like is_1:sh_material.nazovmat ,
		doba_skladovania 	 INTEGER ,
		stavmat 	 like is_1:sh_stavy.stavmat ,
		mat_zdroje 	 DEC(12,3) ,
		mat_obj 	 DEC(12,3) ,
		mat_str 	 DEC(12,3) ,
		skrmj 	 like is_1:sh_material.skrmj ,
		pod 	 like is_1:sh_material.pod ,
		cissklad 	 like is_1:sh_material.cissklad ,
		evidcis 	 like is_1:sh_material.evidcis ,
		id 	 like is_1:sh_material.id ,
		skrnaz 	 like kalkul:kalpolskupina.skrnaz ,
		popis 	 CHAR(180) ,
		spracovatelnost 	 like kalkul:kalpolskupina.spracovatelnost ,
		doba_skladovania2 	 INTEGER 
	 end record 
##@@19
##@@49
define pp_49 record 
		idnad_spol1 	 like exp_kalk:nad_spol1.id ,
		str 	 like ciselniky:str.str ,
		nsp1 	 like exp_kalk:nad_spol1.nsp1 ,
		snazf 	 like vyrobky:firma.snazf ,
		idpl_kalend_obd 	 like pl_kalendar_obdobi.id ,
		obdobie 	 like pl_kalendar_obdobi.obdobie ,
		rezerv_kapacita 	 like pl_rezerv_kapacita.rezerv_kapacita ,
		rezerv_perc 	 DEC(4,1) ,
		...
		zac_obdobia 	 like pl_kalendar_obdobi.zac_obdobia ,
		kon_obdobia 	 like pl_kalendar_obdobi.kon_obdobia ,
		idpo_stroje 	 like pl_rezerv_kapacita.idpo_stroje 
	 end record 
##@@49
##@@26
...
define pp_26 record 
		id 	 like pl_parametre.id ,
		cpv 	 like pl_parametre.cpv ,
		rezerva_per 	 like pl_parametre.rezerva_per ,
		poc_per_vyvaz 	 like pl_parametre.poc_per_vyvaz ,
		poc_per_prehl 	 like pl_parametre.poc_per_prehl ,
		rezervacia_zapnuta 	 like pl_parametre.rezervacia_zapnuta 
	 end record 
##@@26
##@@52
{
define pp_52 record 
		datprijmu 	 like is_1:sh_stavy.datprijmu ,
		stavmat 	 like is_1:sh_stavy.stavmat ,
		blokovmnozstvo 	 like is_1:sh_stavy.blokovmnozstvo ,
		doba_skladovania 	 INTEGER 
	 end record 
##@@52
##@@05
define pp_05 record 
		...
		nazstroja 	 like polot:po_stroje.nazstroja ,
		idpo_stroje 	 like pl_kapkalendar.idpo_stroje ,
		cpv 	 like pl_kapkalendar.cpv ,
		cov 	 like pl_kapkalendar.cov ,
		cstroj 	 like pl_kapkalendar.cstroj ,
		zac_useku 	 like pl_kapkalendar.zac_useku ,
		kon_useku 	 like pl_kapkalendar.kon_useku ,
		kod_useku 	 like pl_kapkalendar.kod_useku ,
		den_tyz 	 like pl_den_tyz.naz_dna ,
		dlzka_useku 	 like pl_kapkalendar.dlzka_useku ,
		smennost 	 like pl_kapkalendar.smennost ,
		popis 	 like pl_smennost.popis ,
		idzmenil 	 like pl_kapkalendar.idzmenil ,
		priezvisko 	 CHAR(50) ,
		meno 	 CHAR(20) ,
		c_zmeny 	 like pl_kapkalendar.c_zmeny ,
		prestavka 	 SMALLINT 
	 end record 
##@@05
##@@53
define pp_53 record 
		id 	 like pl_model_rezerv.id ,
		cpv 	 like pl_model_rezerv.cpv ,
		obdobie 	 like pl_model_rezerv.obdobie ,
		idnad_spol1 	 like pl_model_rezerv.idnad_spol1 ,
		datplat 	 like pl_model_rezerv.datplat ,
		csf 	 like pl_model_rezerv.csf ,
		cov_tlace 	 like pl_model_rezerv.cov_tlace ,
		plan_final_kg 	 like pl_model_rezerv.plan_final_kg ,
		priem_gram 	 like pl_model_rezerv.priem_gram ,
		priem_sirprod 	 like pl_model_rezerv.priem_sirprod ,
		priem_zakazka 	 like pl_model_rezerv.priem_zakazka ,
		priem_pocval 	 like pl_model_rezerv.priem_pocval ,
		pr_perc_vyr_valce 	 like pl_model_rezerv.pr_perc_vyr_valce ,
		nhod_tlac 	 like pl_model_rezerv.nhod_tlac ,
		nhod_vyr_valce 	 like pl_model_rezerv.nhod_vyr_valce ,
		idzmenil 	 like pl_model_rezerv.idzmenil ,
		celemeno 	 CHAR(100) ,
		cas_zmeny 	 like pl_model_rezerv.cas_zmeny 
	 end record 
##@@53
##@@54
define pp_54 record 
...
define pp_42 record 
		...
		cov 	 like vp_polot.cov ,
		nazof 	 like v_prikazy.nazof ,
		sidf 	 like v_prikazy.sidf ,
		oznac 	 like v_prikazy.oznac ,
		cstroj 	 like denne_plany.cstroj ,
		nazstroja 	 like polot:po_stroje.nazstroja ,
		poradie 	 like denne_plany.poradie ,
		nazsort 	 like vp_polot.nazsort ,
		mnoz_kg 	 like vp_polot.mnoz_kg ,
		nhod 	 DEC(4,1) ,
		cas_odchylky 	 INTERVAL DAY(3) TO MINUTE ,
		cov_pred 	 like vp_polot.cov ,
		cas_odchylky_pred 	 INTERVAL DAY(3) TO MINUTE 
	 end record 
##@@42
##@@51
define pp_51 record 
		id 	 like exp_kalk:nad_spol1.id ,
		pref_tlac1 	 like exp_kalk:nad_spol1.pref_tlac1 ,
		porf2 	 like vyrobky:firma.porf2 ,
		snazf 	 like vyrobky:firma.snazf ,
		nazof 	 like vyrobky:firma.nazof ,
		sidf 	 like vyrobky:firma.sidf 
	 end record 
##@@51
##@@50
define pp_50 record 
		id 	 like pl_skup_stroj.id ,
		cpv 	 like pl_skup_stroj.cpv ,
		cov 	 like pl_skup_stroj.cov ,
		idpo_stroje_skup 	 like pl_skup_stroj.idpo_stroje_skup ,
		cstroj_skup 	 like polot:po_stroje.cstroj ,
		nazstroja_skup 	 like polot:po_stroje.nazstroja ,
		idpo_stroje 	 like pl_skup_stroj.idpo_stroje ,
		cstroj 	 like polot:po_stroje.cstroj ,
		nazstroja 	 like polot:po_stroje.nazstroja ,
		platnost 	 like pl_skup_stroj.platnost ,
		cas_zmeny 	 like pl_skup_stroj.cas_zmeny ,
		zmenil 	 like pl_skup_stroj.zmenil ,
		priezvisko 	 CHAR(50) ,
		meno 	 CHAR(20) 
	 end record 
##@@50
##@@47
define pp_47 record 
		id 	 like pl_kalendar_obdobi.id ,
		cpv 	 like pl_kalendar_obdobi.cpv ,
		obdobie 	 like pl_kalendar_obdobi.obdobie ,
		zac_obdobia 	 like pl_kalendar_obdobi.zac_obdobia ,
		kon_obdobia 	 like pl_kalendar_obdobi.kon_obdobia ,
		rezervovane 	 CHAR(3) ,
		cas_uzavretia 	 like pl_rezerv_uzavretie.cas_uzavretia ,
		iduzavrel 	 like pl_rezerv_uzavretie.iduzavrel ,
		priezvisko 	 CHAR(50) ,
		meno 	 CHAR(20) 
	 end record 
##@@47
...
##@@45
define pp_45 record 
		pod 	 like ciselniky:organizacny.pod ,
		str 	 like ciselniky:organizacny.str ,
		div 	 like ciselniky:organizacny.div ,
		nazov 	 like ciselniky:str.nazov 
	 end record 
##@@45
##@@43
...
##@@27
define pp_27 record 
		id 	 like pl_vynimka.id ,
		cpv 	 like pl_vynimka.cpv ,
		ckz 	 like pl_vynimka_zak.ckz ,
		porc 	 like pl_vynimka_zak.porc ,
		kod_storna 	 like k_zmluvy:kpolozky.kod_storna ,
		druh_vynimky 	 like pl_vynimka.druh_vynimky ,
		typ_vynimky 	 like pl_vynimka.typ_vynimky ,
		cspred 	 like pl_vynimka.cspred ,
		stav_vynimky 	 like pl_vynimka.stav_vynimky ,
		dovod 	 like pl_vynimka.dovod ,
		termin_poz_uv 	 like pl_vynimka_zak.termin_poz_uv ,
		nazof 	 like vyrobky:firma.nazof ,
		oznac 	 like vyrobky:motiv.oznac ,
		popis 	 like vyrobky:zlozenie.popis ,
		mnozkg 	 like k_zmluvy:kpolozky.mnozkg ,
		pozadoval 	 like pl_vynimka.pozadoval ,
		idvytvoril 	 like pl_vynimka.idvytvoril ,
		cas_vytvorenia 	 like pl_vynimka.cas_vytvorenia ,
		priez_vytv 	 CHAR(50) ,
		meno_vytv 	 CHAR(20) ,
		idschvalil 	 like pl_vynimka.idschvalil ,
		cas_schvalenia 	 like pl_vynimka.cas_schvalenia ,
		priez_schval 	 CHAR(50) ,
		meno_schval 	 CHAR(20) ,
		idstornoval 	 like pl_vynimka.idstornoval ,
		cas_storna 	 like pl_vynimka.cas_storna ,
		priez_stor 	 CHAR(50) ,
		meno_stor 	 CHAR(20) ,
		idkpolozky 	 like pl_vynimka_zak.idkpolozky ,
		idkpolozky_fors 	 like pl_vynimka_zak.idkpolozky_fors ,
		druh_zak 	 like pl_vynimka_zak.druh_zak ,
		idpl_vynimka 	 like pl_vynimka_zak.idpl_vynimka ,
		cislo_vp 	 like v_prikazy.cislo_vp ,
		stav_prik 	 like v_prikazy.stav_prik 
	 end record 
##@@27
##@@08
define pp_08 record 
		porf 	 like vyrobky:firma.porf ,
		podnik 	 like vyrobky:firma.podnik ,
		porf2 	 like vyrobky:firma.porf2 ,
		snazf 	 like vyrobky:firma.snazf ,
		nazof 	 like vyrobky:firma.nazof ,
		sidf 	 like vyrobky:firma.sidf ,
		ico 	 like vyrobky:firma.ico ,
		cispred 	 like k_zmluvy:obchpartneri.cispred ,
		pocpodm 	 SMALLINT 
	 end record 
##@@08
##@@40
define pp_40 record 
		...
		cispred 	 like k_zmluvy:obchpartneri.cispred ,
		pocpodm 	 SMALLINT ,
		platnostz 	 like exp_kalk:nad_spol1.platnostz 
	 end record 
##@@40
##@@41
define pp_41 record 
		cpr 	 like k_zmluvy:ref_predaj.cpr ,
		titul 	 like k_zmluvy:ref_predaj.titul ,
		meno 	 like k_zmluvy:ref_predaj.meno ,
		priezv 	 like k_zmluvy:ref_predaj.priezv ,
		popis 	 like k_zmluvy:ref_predaj.popis 
	 end record 
##@@41
##@@07
define pp_07 record 
		id 	 like pl_dodpodmfirmy.id ,
		cpv 	 like pl_dodpodmfirmy.cpv ,
		cpr 	 like pl_dodpodmfirmy.cpr ,
		porf2 	 like pl_dodpodmfirmy.porf2 ,
		idfirma 	 like pl_dodpodmfirmy.idfirma ,
		snazf 	 like vyrobky:firma.snazf ,
		koncern 	 CHAR(1) ,
		nazof 	 like vyrobky:firma.nazof ,
		sidf 	 like vyrobky:firma.sidf ,
		ico 	 like vyrobky:firma.ico ,
		idpl_kodzakazky 	 like pl_dodpodmfirmy.idpl_kodzakazky ,
		kod_zakazky 	 like pl_kodzakazky.kod_zakazky ,
		popis_zakazky 	 like pl_kodzakazky.popis_zakazky ,
		idpl_skuptovaru 	 like pl_dodpodmfirmy.idpl_skuptovaru ,
		popis_skupiny 	 like pl_skupinatovaru.popis_skupiny ,
		idpl_startdatum 	 like pl_dodpodmfirmy.idpl_startdatum ,
		popis_datumu 	 like pl_startdatum.popis_datumu ,
		ramcova_kz 	 like pl_dodpodmfirmy.ramcova_kz ,
		dni_dodania 	 like pl_dodpodmfirmy.dni_dodania ,
		platnost 	 like pl_dodpodmfirmy.platnost ,
		cas_zmeny 	 like pl_dodpodmfirmy.cas_zmeny ,
		idzmenil 	 like pl_dodpodmfirmy.idzmenil ,
		priezvisko 	 CHAR(50) ,
		meno 	 CHAR(20) 
	 end record 
##@@07
##@@39
define pp_39 record 
		id 	 like pl_zlozenietovaru.id ,
		idpl_skupinatovaru 	 like pl_zlozenietovaru.idpl_skupinatovaru ,
		popis_skupiny 	 like pl_skupinatovaru.popis_skupiny ,
		kvyrobku 	 like pl_zlozenietovaru.kvyrobku ,
		naztovar 	 like vyrobky:tovar.naztovar 
	 end record 
##@@39
##@@38
define pp_38 record 
		kvyrobku 	 like vyrobky:tovar.kvyrobku ,
		naztovar 	 like vyrobky:tovar.naztovar 
	 end record 
##@@38
##@@37
define pp_37 record 
		id 	 like pl_skupinatovaru.id ,
		popis_skupiny 	 like pl_skupinatovaru.popis_skupiny 
	 end record 
##@@37
##@@35
define pp_35 record 
		id 	 like pl_startdatum.id ,
		popis_datumu 	 like pl_startdatum.popis_datumu ,
		databaza 	 like pl_startdatum.databaza ,
		tabulka 	 like pl_startdatum.tabulka ,
		stlpec 	 like pl_startdatum.stlpec 
	 end record 
##@@35
##@@10
define pp_10 record 
		id 	 like pl_kodzakazky.id ,
		kod_zakazky 	 like pl_kodzakazky.kod_zakazky ,
		popis_zakazky 	 like pl_kodzakazky.popis_zakazky 
	 end record 
##@@10
...
##@@12
define pp_12 record 
		id 	 like pl_pouzistroj.id ,
		cpv 	 like pl_pouzistroj.cpv ,
		cov 	 like pl_pouzistroj.cov ,
		csv 	 like pl_pouzistroj.csv ,
		nazov 	 like kalkul:sort.nazov ,
		ctv 	 like technologie.ctv ,
		naztech 	 like technologie.naztech ,
		idtechzl 	 like pl_pouzistroj.idtechzl ,
		cisoper 	 like pl_tech_zl.cisoper ,
		nazoper 	 like pl_oper.nazoper ,
		idfivy 	 like pl_pouzistroj.idfivy ,
		crefv 	 like vyrobky:fivy.crefv ,
		kodzmen 	 like vyrobky:fivy.kodzmen ,
		oznac 	 like vyrobky:motiv.oznac ,
		cstroj 	 like pl_pouzistroj.cstroj ,
		nazstroja 	 like polot:po_stroje.nazstroja ,
		idpo_stroje 	 like pl_pouzistroj.idpo_stroje ,
		priorita 	 like pl_pouzistroj.priorita ,
		c_zmeny 	 like pl_pouzistroj.c_zmeny ,
		priezvisko 	 CHAR(50) ,
		meno 	 CHAR(20) ,
		idzmenil 	 like pl_pouzistroj.idzmenil 
	 end record 
##@@12
##@@32
define pp_32 record 
...
##@@20
define pp_20 record 
		extcisdkz 	 like is_1:sh_nkzkmen.extcisdkz ,
		ciszasob 	 like is_1:sh_nkzkmen.ciszasob ,
		datvystav 	 like is_1:sh_nkzkmen.datvystav ,
		potvmnoz 	 like is_1:sh_nkzpolo.potvmnoz ,
		dodmnoz 	 DEC(12,3) ,
		porcispoz 	 like is_1:sh_poziadav.porcispoz ,
		datpotvrd 	 like is_1:sh_poziadav.datpotvrd ,
		ziadmnoz 	 like is_1:sh_poziadav.ziadmnoz ,
		cisloziad 	 like is_1:sh_poziadav.cisloziad ,
		nazof 	 like vyrobky:firma.nazof ,
		intcisdkz 	 like is_1:sh_nkzkmen.intcisdkz ,
		sposdopr 	 like is_1:sh_nkzkmen.sposdopr ,
		statdkz 	 like is_1:sh_nkzkmen.statdkz ,
		datposlzm 	 like is_1:sh_nkzkmen.datposlzm ,
		poznziad 	 like is_1:sh_poziadav.poznziad 
	 end record 
##@@20
##@@30
define pp_30 record 
		ckz 	 like k_zmluvy:kpolozky.ckz ,
		porc 	 like k_zmluvy:kpolozky.porc ,
		datpoz 	 like k_zmluvy:kzmluvy.datpoz ,
		oznac 	 like vyrobky:motiv.oznac ,
		pocval 	 like vyrobky:motiv.pocval ,
		sirprod 	 like vyrobky:motiv.sirprod ,
		sortim 	 like k_zmluvy:kpolozky.sortim ,
		skratnaz 	 like polot:po_kratsor.skratnaz ,
		vzorkahrubka 	 like k_zmluvy:kpolozky.vzorkahrubka ,
		vzorkagram 	 like k_zmluvy:kpolozky.vzorkagram ,
		mnozkg 	 like k_zmluvy:kpolozky.mnozkg ,
		nazof 	 like vyrobky:firma.nazof ,
		crefv 	 like vyrobky:fivy.crefv ,
		kodzmen 	 like vyrobky:fivy.kodzmen 
...
##@@31
define pp_31 record 
		porf 	 like vyrobky:farbymot.porf ,
		strana 	 like vyrobky:farbymot.strana ,
		lak 	 like vyrobky:farbymot.lak ,
		novafarba 	 like vyrobky:farbymot.novafarba ,
		farba 	 like vyrobky:farbymot.farba ,
		panton 	 like vyrobky:farbymot.panton ,
		krytie 	 like vyrobky:farbymot.krytie ,
		kzakfar 	 like vyrobky:farbymot.kzakfar ,
		raster 	 like vyrobky:farbymot.raster ,
		digit_filmy 	 like vyrobky:ftpval.digit_filmy ,
		plocho_kruh 	 like vyrobky:ftpval.plocho_kruh ,
		poc_nahr 	 SMALLINT ,
		crefv 	 like vyrobky:fivy.crefv 
	 end record 
##@@31
...
define pp_25 record 
		...
		kon_plan 	 like pl_harmpolozka.kon_plan ,
		oznac 	 like v_prikazy.oznac ,
		vyrnaz 	 like polot:po_kratsor.vyrnaz ,
		csv 	 like vp_polot.csv ,
		nazsort 	 like vp_polot.nazsort ,
		nhod 	 DEC(5,2) ,
		pocval 	 like v_p_motiv.pocval ,
...
##@@29
define pp_29 record 
		idpl_harm 	 like pl_harmpolozka.idpl_harm ,
		idpo_stroje 	 like pl_harmpolozka.idpo_stroje ,
		cstroj 	 like polot:po_stroje.cstroj ,
		nazstroja 	 like polot:po_stroje.nazstroja ,
...
##@@23
define pp_23 record 
		perioda 	 like pl_perioda.perioda ,
		den_zaciatku 	 like pl_perioda.den_zaciatku ,
		cas_zaciatku 	 like pl_perioda.cas_zaciatku ,
		dlzka_periody 	 like pl_perioda.dlzka_periody ,
		zac_posun_tyz 	 like pl_perioda.zac_posun_tyz ,
		kon_posun_tyz 	 like pl_perioda.kon_posun_tyz 
	 end record 
##@@23
##@@24
define pp_24 record 
		id 	 like pl_typprac_ulohy.id ,
		kod_ulohy 	 like pl_typprac_ulohy.kod_ulohy ,
		popis_ulohy 	 like pl_typprac_ulohy.popis_ulohy 
	 end record 
##@@24
##@@22
define pp_22 record 
		coo 	 like kalkul:techpost.coo 
	 end record 
##@@22
##@@21
define pp_21 record 
		...
		hrubka 	 like is_1:sh_popis.hrubka ,
		sirka 	 like is_1:sh_popis.sirka ,
		ckpol 	 like kalkul:kalpol.ckpol ,
		nahrad 	 like kalkul:kalpol.nahrad ,
		csn 	 like kalkul:normy.csn 
	 end record 
##@@21
##@@17
define pp_17 record 
		cov 	 like kalkul:sort.cov ,
		csv 	 like kalkul:sort.csv ,
		nazov 	 like kalkul:sort.nazov 
	 end record 
##@@17
##@@15
define pp_15 record 
		id 	 like pl_sledpolozkadruh.id ,
		kod_polozky 	 like pl_sledpolozkadruh.kod_polozky ,
		popis_polozky 	 like pl_sledpolozkadruh.popis_polozky 
	 end record 
##@@15
##@@16
define pp_16 record 
		id 	 like pl_typzdroja.id ,
		kod_zdroja 	 like pl_typzdroja.kod_zdroja ,
		popis_zdroja 	 like pl_typzdroja.popis_zdroja 
	 end record 
##@@16
##@@13
define pp_13 record 
		porc 	 like vyrobky:fivy.porc ,
		crefv 	 like vyrobky:fivy.crefv ,
		kodzmen 	 like vyrobky:fivy.kodzmen ,
		plcsort 	 like vyrobky:fivy.plcsort ,
		oznac 	 like vyrobky:motiv.oznac ,
		obvodval 	 like vyrobky:motiv.obvodval ,
		pocf 	 like vyrobky:fivy.pocf 
	 end record 
##@@13
##@@11
define pp_11 record 
		smennost 	 like pl_smennost.smennost ,
		popis 	 like pl_smennost.popis 
	 end record 
##@@11
##@@09
define pp_09 record 
		id 	 like pl_disponibil.id ,
		idpl_kapkalendar 	 like pl_disponibil.idpl_kapkalendar ,
		cas_zac 	 like pl_disponibil.cas_zac ,
		cas_kon 	 like pl_disponibil.cas_kon 
	 end record 
##@@09
##@@06
define pp_06 record 
		den_tyz 	 like pl_den_tyz.den_tyz ,
		naz_dna 	 like pl_den_tyz.naz_dna 
	 end record 
##@@06
##@@04
define pp_04 record 
		id 	 like polot:po_stroje.id ,
		cp 	 like polot:po_stroje.cp ,
		co 	 like polot:po_stroje.co ,
		cstroj 	 like polot:po_stroje.cstroj ,
		nazstroja 	 like polot:po_stroje.nazstroja ,
		kodstr 	 like polot:po_stroje.kodstr ,
		cstrojippo 	 like polot:po_stroje.cstrojippo ,
		kodss 	 like polot:po_stroje.kodss 
	 end record 
##@@04
##@@33
define pp_33 record 
		id 	 like tpv:pl_tech_zl.id ,
		cpv 	 like tpv:pl_tech_zl.cpv ,
		ctv 	 like tpv:pl_tech_zl.ctv ,
		cisoper 	 like tpv:pl_tech_zl.cisoper ,
		ctoper 	 like tpv:pl_tech_zl.ctoper ,
		nazoper 	 like tpv:pl_oper.nazoper ,
		naztech 	 like tpv:technologie.naztech 
	 end record 
##@@33
#@@039
}
...
define gdatplat decimal(4,0)
define gobdplat  datetime year to month
define gpodnik smallint
define gid_zam integer
define glast_modify like pl_poziad_progn.last_modify
define gdruh_vynimky char(1)
...

{
		gpom66 ,prazd166 record
			porc like tpv:tlaciarne.porc,
			nazov like tpv:tlaciarne.nazov
		end record ,
...
{
define vstup record
   idkpolozky like k_zmluvy:kpolozky.id,
   pcrefv like k_zmluvy:kpolozky.pcrefv,
   podnik like k_zmluvy:kpolozky.podnik,
   sortim like k_zmluvy:kpolozky.sortim,
   varianta like tpv:v_prikazy.varianta,
   cso like kalkul:normy.csn,
   ckpol like kalkul:normy.ckpol,
   sirka like vp_polot.sirka,
   mikron like vp_polot.mikron
end record
...
############################
define podnik like k_zmluvy:kpolozky.podnik
define cso like kalkul:normy.csn
define ckpol like kalkul:normy.ckpol
...
####################
define aa char
--define puser like sysadm:users.user_id
	options 
...
let gpodnik = 6 --special for test
let gdatplat = 1901
{
if aa then
...
#################################
define p_menu like satuziv:skupina.menu
let pfilter = null
let pcislo = null
whenever error continue
select bb.filter,bb.cislo into pfilter,pcislo 
...
################
define pamenu like satuziv:privileg.menu 
...
######################
define sql_ok char
define l_zam_num like sysadm:users.osc
define l_login like sysadm:users.user_id
