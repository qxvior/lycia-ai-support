...
MAIN
	...
	OPEN WINDOW mywin WITH FORM "form/cnt_table_flexbox_thumbnail_style2"
 	CALL fgl_settitle("CSS FlexBox Display Array Example")
  #CALL ui.Interface.setImage("{CONTEXT}/public/querix/icon/png/16/application-info.png")
	CALL ui.Interface.setText("FlexBox 2")
