...
DEFINE dt_arr_rec_short_addr TYPE AS DYNAMIC ARRAY OF RECORD
	id STRING,
	loqate_type STRING,  #Address, Postcode (may be others too)
	text STRING,
	highlight STRING,
	description STRING
END RECORD
...
DEFINE dt_rec_search TYPE AS RECORD
		...
		text5 STRING,					#The search text5 to find. Ideally a postcode or the start of the address.
		text6 STRING					#The search text6 to find. Ideally a postcode or the start of the address.
END RECORD
