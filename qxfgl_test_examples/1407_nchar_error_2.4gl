...
--      ins_nchar_4000, sel_nchar_4000 NCHAR(2656),   --> error -999 doesn't appear  
   ...
   FOR i = 1 TO 8
      LET ins_nchar_4000 = ins_nchar_4000 CLIPPED,"ääääääääääääääääääääääääääääääääääääääääääääääääääääääääääääääääääääääääääääääääääääääääääääääääääääääääääääääääääääääääääääääääääääääääääääääääääääääääääääääääääääääääääääääääääääääääääääääääääääääääääääääääääääääääääääääääääääääääääääääääääääääääää"
   END FOR      
