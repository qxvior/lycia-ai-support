...
MAIN
   ...
   DROP TABLE lyc_7886_update_when_error_3
   CREATE TABLE lyc_7886_update_when_error_3
   (row_number INTEGER,
    col_char CHAR(80)
   )

   INSERT INTO lyc_7886_update_when_error_3 VALUES(1,"1st row")
   INSERT INTO lyc_7886_update_when_error_3 VALUES(2,"2nd row")
   INSERT INTO lyc_7886_update_when_error_3 VALUES(3,"3rd row")
   INSERT INTO lyc_7886_update_when_error_3 VALUES(4,"4th row")
   INSERT INTO lyc_7886_update_when_error_3 VALUES(5,"5th row")
   IF SQLCA.SQLCODE <> 0 THEN DISPLAY "1. SQLCA.SQLCODE = ",SQLCA.SQLCODE EXIT PROGRAM END IF

   DECLARE cursor_1 CURSOR FOR 
   	SELECT row_number,col_char FROM lyc_7886_update_when_error_3 ORDER BY row_number

	SQL UPDATE lyc_7886_update_when_error_3 SET col_char = (CASE WHEN row_number = 1 THEN "1st row updated 1" ELSE "NULL" END) WHERE row_number = 1 END SQL
   IF SQLCA.SQLCODE <> 0 THEN DISPLAY "2. SQLCA.SQLCODE = ",SQLCA.SQLCODE END IF
	SELECT col_char INTO v_char FROM lyc_7886_update_when_error_3 WHERE row_number = 1
   IF SQLCA.SQLCODE <> 0 THEN DISPLAY "3. SQLCA.SQLCODE = ",SQLCA.SQLCODE ELSE DISPLAY "3. ",v_char END IF

	SQL UPDATE lyc_7886_update_when_error_3 SET col_char = CASE WHEN row_number = 1 THEN "1st row updated 2" ELSE "NULL" END WHERE row_number = 5 END SQL
   IF SQLCA.SQLCODE <> 0 THEN DISPLAY "4. SQLCA.SQLCODE = ",SQLCA.SQLCODE END IF
	SELECT col_char INTO v_char FROM lyc_7886_update_when_error_3 WHERE row_number = 5
   IF SQLCA.SQLCODE <> 0 THEN DISPLAY "5. SQLCA.SQLCODE = ",SQLCA.SQLCODE ELSE DISPLAY "5. ",v_char END IF

	SQL UPDATE lyc_7886_update_when_error_3 SET col_char = 
   ...
   END FOREACH
	...
	LET v_int_init = 1 
	SQL UPDATE lyc_7886_update_when_error_3 SET col_char = (CASE WHEN $v_int_init = 1 THEN "1st row updated 9" ELSE "NULL" END) WHERE row_number = 1 END SQL
   ...
   IF SQLCA.SQLCODE <> 0 THEN DISPLAY "19. SQLCA.SQLCODE = ",SQLCA.SQLCODE ELSE DISPLAY "19. ",v_char END IF
	...
	SQL UPDATE lyc_7886_update_when_error_3 SET col_char = CASE WHEN $v_int_init = 5 THEN "1st row updated 10" ELSE "NULL" END WHERE row_number = 5 END SQL 
