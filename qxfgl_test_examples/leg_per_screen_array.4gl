...
MAIN
	...
	#OPEN WINDOW wScreenArray WITH FORM "per/leg_per_screen_array"
	OPEN WINDOW wScreenArray WITH FORM "leg_per_screen_array_translated"
	CALL ui.Interface.setText("Legacy PER sc")
#--------------
#PROMPT "" FOR CHAR x
#ON KEY (control-t)  #COMMAND KEY (control-t)
#	 CALL fgl_winmessage("my control","my control","info")
...
#-------------
	MENU "PER_Screen_Array"
		COMMAND KEY (control-t)  #COMMAND KEY (control-t)
	 		CALL fgl_winmessage("my control","my control in MENU ","info")
		...
		COMMAND "INPUT"
			...
			DIALOG
				...
				ON KEY (control-t)
					CALL fgl_winmessage("my control","my control in DIALOG INPUT ","info")
				ON ACTION "EXIT"
					EXIT DIALOG
