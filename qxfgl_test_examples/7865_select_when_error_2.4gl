...
MAIN
   ...
   DROP TABLE lyc_7865_select_when_error_2
   CREATE TABLE lyc_7865_select_when_error_2
   (row_number INTEGER,
    col_char CHAR(80)
   )

   INSERT INTO lyc_7865_select_when_error_2 VALUES(1,"1st row")
   INSERT INTO lyc_7865_select_when_error_2 VALUES(2,"2nd row")
   INSERT INTO lyc_7865_select_when_error_2 VALUES(3,"3rd row")
   INSERT INTO lyc_7865_select_when_error_2 VALUES(4,"4th row")
   INSERT INTO lyc_7865_select_when_error_2 VALUES(5,"5th row")
   IF SQLCA.SQLCODE <> 0 THEN DISPLAY "1. SQLCA.SQLCODE = ",SQLCA.SQLCODE EXIT PROGRAM END IF

	SELECT row_number,CASE WHEN row_number = 1 THEN "1st row" ELSE "NULL" END INTO v_row_number,v_char FROM lyc_7865_select_when_error_2 WHERE row_number = 1
   IF SQLCA.SQLCODE <> 0 THEN DISPLAY "2. SQLCA.SQLCODE = ",SQLCA.SQLCODE ELSE DISPLAY "2. ", v_row_number,"  ",v_char END IF

	SELECT row_number,CASE WHEN row_number = 1 THEN "1st row" ELSE "NULL" END INTO v_row_number,v_char FROM lyc_7865_select_when_error_2 WHERE row_number = 5
   IF SQLCA.SQLCODE <> 0 THEN DISPLAY "3. SQLCA.SQLCODE = ",SQLCA.SQLCODE ELSE DISPLAY "3. ", v_row_number,"  ",v_char END IF
	...
	FROM lyc_7865_select_when_error_2 WHERE row_number = 1
   IF SQLCA.SQLCODE <> 0 THEN DISPLAY "4. SQLCA.SQLCODE = ",SQLCA.SQLCODE ELSE DISPLAY "4. ", v_row_number,"  ",v_char END IF
	...
	SELECT row_number, 
		  ...
		  END
	INTO v_row_number,v_char
	FROM lyc_7865_select_when_error_2 WHERE row_number = 5
   IF SQLCA.SQLCODE <> 0 THEN DISPLAY "5. SQLCA.SQLCODE = ",SQLCA.SQLCODE ELSE DISPLAY "5. ", v_row_number,"  ",v_char END IF
	...
	SELECT row_number,
		  ...
		  END
	INTO v_row_number,v_char
	FROM lyc_7865_select_when_error_2 WHERE row_number = 0
   IF SQLCA.SQLCODE <> 0 THEN DISPLAY "6. SQLCA.SQLCODE = ",SQLCA.SQLCODE ELSE DISPLAY "6. ", v_row_number,"  ",v_char END IF
	...
	SELECT row_number,
		  ...
		  END
	INTO v_row_number,v_char
	FROM lyc_7865_select_when_error_2
   ...
   DECLARE cursor_3 CURSOR FOR
	SELECT row_number, 
		  CASE WHEN row_number = 1 THEN "1st row"
				 ...
				 ELSE "NULL"
		  END
	FROM lyc_7865_select_when_error_2 ORDER BY row_number
   ...
   DECLARE cursor_4 CURSOR FOR
	SELECT row_number, 
		  CASE WHEN row_number = 1 THEN "1st row"
				 ...
				 ELSE "NULL"
		  END
	FROM lyc_7865_select_when_error_2 WHERE row_number BETWEEN 2 AND 4 ORDER BY row_number
