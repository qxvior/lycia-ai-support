MAIN
	...
	OPEN WINDOW G534 WITH FORM "3615/3615_input_table_construct_2"   
	FOR i=1 to 100
	...
	INPUT ARRAY l_arr_rec_bic WITHOUT DEFAULTS FROM sr_bic.* ATTRIBUTE(UNBUFFERED, APPEND ROW = 1, INSERT ROW = 0, DELETE ROW = 0, AUTO APPEND = 1)
			ON ACTION "Filter"
