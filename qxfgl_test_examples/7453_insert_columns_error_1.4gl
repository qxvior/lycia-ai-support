...
MAIN
	...
	col_char_1 CHAR(1),
	col_char_2 CHAR(1)    --> If column col_char_2 is commented out, then it works correctly
	)
	...
	(
	col_char_1 CHAR(1),   --> If column col_char_1 is commented out, then it works correctly
	col_serial SERIAL NOT NULL,
	col_char_2 CHAR(1)
	)
	...
	######################### lyc_7453_1 #########################
	INSERT INTO lyc_7453_1(col_serial,col_char_1) VALUES(0,"a")
	INSERT INTO lyc_7453_1(col_serial,col_char_1) VALUES(0,"b")
	INSERT INTO lyc_7453_1(col_serial,col_char_1) VALUES(0,"c")
	...
	INSERT INTO lyc_7453_1(col_serial,col_char_1) VALUES(0,"d")
	FOREACH cur_1 INTO l_serial, l_char_1
	DISPLAY l_serial,"    ",l_char_1
	END FOREACH
	...
	######################### lyc_7453_2 #########################
	INSERT INTO lyc_7453_2(col_serial,col_char_2) VALUES(0,"a")
	INSERT INTO lyc_7453_2(col_serial,col_char_2) VALUES(0,"b")
	INSERT INTO lyc_7453_2(col_serial,col_char_2) VALUES(0,"c")
	...
	INSERT INTO lyc_7453_2(col_serial,col_char_2) VALUES(0,"d")
	FOREACH cur_2 INTO l_serial, l_char_2
	DISPLAY l_serial,"    ",l_char_2
	END FOREACH
	...
	######################### lyc_7453_3 #########################
	INSERT INTO lyc_7453_3(col_serial,col_char_1) VALUES(0,"a")
	INSERT INTO lyc_7453_3(col_serial,col_char_1) VALUES(0,"b")
	INSERT INTO lyc_7453_3(col_serial,col_char_1) VALUES(0,"c")
	...
	INSERT INTO lyc_7453_3(col_serial,col_char_1) VALUES(0,"d")
	FOREACH cur_3 INTO l_serial, l_char_1
	DISPLAY l_serial,"    ",l_char_1
	END FOREACH
