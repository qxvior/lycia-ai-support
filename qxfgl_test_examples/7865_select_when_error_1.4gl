...
MAIN
   ...
   DROP TABLE lyc_7865_select_when_error_1
   CREATE TABLE lyc_7865_select_when_error_1
   (row_number INTEGER,
    col_char CHAR(80)
   )

   INSERT INTO lyc_7865_select_when_error_1 VALUES(1,"1st row")
   INSERT INTO lyc_7865_select_when_error_1 VALUES(2,"2nd row")
   INSERT INTO lyc_7865_select_when_error_1 VALUES(3,"3rd row")
   INSERT INTO lyc_7865_select_when_error_1 VALUES(4,"4th row")
   INSERT INTO lyc_7865_select_when_error_1 VALUES(5,"5th row")
   IF SQLCA.SQLCODE <> 0 THEN DISPLAY "1. SQLCA.SQLCODE = ",SQLCA.SQLCODE EXIT PROGRAM END IF

	PREPARE p_select FROM "SELECT row_number,CASE WHEN row_number = 1 THEN ""1st row"" ELSE ""NULL"" END FROM lyc_7865_select_when_error_1 WHERE row_number = 1"
   ...
   IF SQLCA.SQLCODE <> 0 THEN DISPLAY "2. SQLCA.SQLCODE = ",SQLCA.SQLCODE ELSE DISPLAY "2. ", v_row_number,"  ",v_char END IF
	...
	PREPARE p_select FROM "SELECT row_number,CASE WHEN row_number = 1 THEN ""1st row"" ELSE ""NULL"" END FROM lyc_7865_select_when_error_1 WHERE row_number = 5"
   EXECUTE p_select INTO v_row_number,v_char
   IF SQLCA.SQLCODE <> 0 THEN DISPLAY "3. SQLCA.SQLCODE = ",SQLCA.SQLCODE ELSE DISPLAY "3. ", v_row_number,"  ",v_char END IF

	LET v_prep = "SELECT row_number,",
							  "CASE WHEN row_number = 1 THEN ""1st row"" ",
									 ...
									 "ELSE ""NULL"" ",
							  "END ",
					 "FROM lyc_7865_select_when_error_1 WHERE row_number = 1"
   ...
   IF SQLCA.SQLCODE <> 0 THEN DISPLAY "4. SQLCA.SQLCODE = ",SQLCA.SQLCODE ELSE DISPLAY "4. ", v_row_number,"  ",v_char END IF
	...
	LET v_prep = "SELECT row_number,", 
							  "CASE WHEN row_number = 1 THEN ""1st row"" ",
									 ...
									 "ELSE ""NULL"" ",
							  "END ",
					 "FROM lyc_7865_select_when_error_1 WHERE row_number = 5"
	PREPARE p_select FROM v_prep
   EXECUTE p_select INTO v_row_number,v_char
   IF SQLCA.SQLCODE <> 0 THEN DISPLAY "5. SQLCA.SQLCODE = ",SQLCA.SQLCODE ELSE DISPLAY "5. ", v_row_number,"  ",v_char END IF
	...
	LET v_prep = "SELECT row_number,",
							  "CASE WHEN row_number = 1 THEN ""1st row"" ",
									 ...
									 "ELSE ""NULL"" ",
							  "END ",
					 "FROM lyc_7865_select_when_error_1 WHERE row_number = 0"
	PREPARE p_select FROM v_prep
   EXECUTE p_select INTO v_row_number,v_char
   IF SQLCA.SQLCODE <> 0 THEN DISPLAY "6. SQLCA.SQLCODE = ",SQLCA.SQLCODE ELSE DISPLAY "6. ", v_row_number,"  ",v_char END IF
	...
	LET v_prep = "SELECT row_number,",
							  "CASE WHEN row_number = 1 THEN ""1st row"" ",
									 ...
									 "ELSE ""NULL"" ",
							  "END ",
					 "FROM lyc_7865_select_when_error_1"
	PREPARE p_select FROM v_prep
   EXECUTE p_select INTO v_row_number,v_char
   ...
   END FOREACH
	...
	LET v_prep = "SELECT row_number,", 
							  "CASE WHEN row_number = 1 THEN ""1st row"" ",
									 ...
									 "ELSE ""NULL"" ",
							  "END ",
					 "FROM lyc_7865_select_when_error_1 ORDER BY row_number"
   ...
   END FOREACH
	...
	LET v_prep = "SELECT row_number,", 
							  "CASE WHEN row_number = 1 THEN ""1st row"" ",
									 ...
									 "ELSE ""NULL"" ",
							  "END ",
					 "FROM lyc_7865_select_when_error_1 WHERE row_number BETWEEN 2 AND 4 ORDER BY row_number"
