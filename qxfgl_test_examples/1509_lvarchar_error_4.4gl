...
MAIN
   ...
   LET stmt = "INSERT INTO lyc_1509(col_lvarchar) VALUES(""",ins_lvarchar,""")"
   ...
   LET stmt = "SELECT col_lvarchar FROM lyc_1509 WHERE col_lvarchar = """,ins_lvarchar,""""
   ...
   DELETE FROM lyc_1509
   LET stmt = "INSERT INTO lyc_1509(col_lvarchar_1) VALUES(""",ins_lvarchar_1,""")"
   ...
   LET stmt = "SELECT col_lvarchar_1 FROM lyc_1509 WHERE col_lvarchar_1 = """,ins_lvarchar_1,""""
   ...
   END FOR      
   DELETE FROM lyc_1509
   LET stmt = "INSERT INTO lyc_1509(col_lvarchar_4000) VALUES(""",ins_lvarchar_4000,""")"
   ...
   LET stmt = "SELECT col_lvarchar_4000 FROM lyc_1509 WHERE col_lvarchar_4000 = """,ins_lvarchar_4000,""""
   PREPARE p_stmt_6 FROM stmt
   IF SQLCA.SQLCODE <> 0 THEN DISPLAY "13. SQLCA.SQLCODE = ",SQLCA.SQLCODE END IF
   EXECUTE p_stmt_6 INTO sel_lvarchar_4000
