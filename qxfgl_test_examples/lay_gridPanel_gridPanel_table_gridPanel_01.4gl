...
MAIN
	...
	CALL ui.Interface.setText("Layout Gp-Tb-Gp")
...
FUNCTION openWindow(pScreen,pForm)
	...
	#form name
	LET formPath = "form/lay_gridPanel_gridPanel_table_gridPanel_01_ps_"
	...
	LET formPath = formPath,"children_mixed" 
...
FUNCTION initData()
	...
	CALL arrMenuSelect.append([800,600,"stretch","stretch"])	
	CALL arrMenuSelect.append([800,600,"left","top"])
	CALL arrMenuSelect.append([800,600,"stretch","top"])
	CALL arrMenuSelect.append([800,600,"left","stretch"])
	CALL arrMenuSelect.append([800,600,"center","center"])
	...
	FOR i = 1 TO 200
		LET arrRecTable[i].ft1 = trim(i), " - Test Data Test Data bla bla bla"
		LET arrRecTable[i].ft2 = trim(i), " - More More More Test Data"		
	END FOR
END FUNCTION