...
MAIN
   ...
   SQL INSERT INTO lyc_0692(col_interval_y_y) VALUES($ins_interval_y_y) END SQL
   IF SQLCA.SQLCODE <> 0 THEN DISPLAY "1.  SQLCA.SQLCODE = ",SQLCA.SQLCODE END IF
   LET sel_interval_y_y = NULL
   SQL SELECT col_interval_y_y INTO $sel_interval_y_y FROM lyc_0692 WHERE col_interval_y_y = $ins_interval_y_y END SQL
   ...
   SQL INSERT INTO lyc_0692(col_interval_y_mo) VALUES($ins_interval_y_mo) END SQL
   IF SQLCA.SQLCODE <> 0 THEN DISPLAY "4.  SQLCA.SQLCODE = ",SQLCA.SQLCODE END IF
   LET sel_interval_y_mo = NULL
   SQL SELECT col_interval_y_mo INTO $sel_interval_y_mo FROM lyc_0692 WHERE col_interval_y_mo = $ins_interval_y_mo END SQL
   ...
   SQL INSERT INTO lyc_0692(col_interval_mo_mo) VALUES($ins_interval_mo_mo) END SQL
   IF SQLCA.SQLCODE <> 0 THEN DISPLAY "7.  SQLCA.SQLCODE = ",SQLCA.SQLCODE END IF
   LET sel_interval_mo_mo = NULL
   SQL SELECT col_interval_mo_mo INTO $sel_interval_mo_mo FROM lyc_0692 WHERE col_interval_mo_mo = $ins_interval_mo_mo END SQL
   ...
   SQL INSERT INTO lyc_0692(col_interval_d_d) VALUES($ins_interval_d_d) END SQL
   IF SQLCA.SQLCODE <> 0 THEN DISPLAY "10. SQLCA.SQLCODE = ",SQLCA.SQLCODE END IF
   LET sel_interval_d_d = NULL
   SQL SELECT col_interval_d_d INTO $sel_interval_d_d FROM lyc_0692 WHERE col_interval_d_d = $ins_interval_d_d END SQL
   ...
   SQL INSERT INTO lyc_0692(col_interval_d9_h) VALUES($ins_interval_d9_h) END SQL
   IF SQLCA.SQLCODE <> 0 THEN DISPLAY "13. SQLCA.SQLCODE = ",SQLCA.SQLCODE END IF
   LET sel_interval_d9_h = NULL
   SQL SELECT col_interval_d9_h INTO $sel_interval_d9_h FROM lyc_0692 WHERE col_interval_d9_h = $ins_interval_d9_h END SQL
   ...
   SQL INSERT INTO lyc_0692(col_interval_d_mi) VALUES($ins_interval_d_mi) END SQL
   IF SQLCA.SQLCODE <> 0 THEN DISPLAY "16. SQLCA.SQLCODE = ",SQLCA.SQLCODE END IF
   LET sel_interval_d_mi = NULL
   SQL SELECT col_interval_d_mi INTO $sel_interval_d_mi FROM lyc_0692 WHERE col_interval_d_mi = $ins_interval_d_mi END SQL
   ...
   SQL INSERT INTO lyc_0692(col_interval_d9_s) VALUES($ins_interval_d9_s) END SQL
   IF SQLCA.SQLCODE <> 0 THEN DISPLAY "19. SQLCA.SQLCODE = ",SQLCA.SQLCODE END IF
   LET sel_interval_d9_s = NULL
   SQL SELECT col_interval_d9_s INTO $sel_interval_d9_s FROM lyc_0692 WHERE col_interval_d9_s = $ins_interval_d9_s END SQL
   ...
   SQL INSERT INTO lyc_0692(col_interval_d_f) VALUES($ins_interval_d_f) END SQL
   IF SQLCA.SQLCODE <> 0 THEN DISPLAY "22. SQLCA.SQLCODE = ",SQLCA.SQLCODE END IF
   LET sel_interval_d_f = NULL
   SQL SELECT col_interval_d_f INTO $sel_interval_d_f FROM lyc_0692 WHERE col_interval_d_f = $ins_interval_d_f END SQL
   ...
   SQL INSERT INTO lyc_0692(col_interval_h_h) VALUES($ins_interval_h_h) END SQL
   IF SQLCA.SQLCODE <> 0 THEN DISPLAY "25. SQLCA.SQLCODE = ",SQLCA.SQLCODE END IF
   LET sel_interval_h_h = NULL
   SQL SELECT col_interval_h_h INTO $sel_interval_h_h FROM lyc_0692 WHERE col_interval_h_h = $ins_interval_h_h END SQL
   ...
   SQL INSERT INTO lyc_0692(col_interval_h9_mi) VALUES($ins_interval_h9_mi) END SQL
   IF SQLCA.SQLCODE <> 0 THEN DISPLAY "28. SQLCA.SQLCODE = ",SQLCA.SQLCODE END IF
   LET sel_interval_h9_mi = NULL
   SQL SELECT col_interval_h9_mi INTO $sel_interval_h9_mi FROM lyc_0692 WHERE col_interval_h9_mi = $ins_interval_h9_mi END SQL
   ...
   SQL INSERT INTO lyc_0692(col_interval_h_s) VALUES($ins_interval_h_s) END SQL
   IF SQLCA.SQLCODE <> 0 THEN DISPLAY "31. SQLCA.SQLCODE = ",SQLCA.SQLCODE END IF
   LET sel_interval_h_s = NULL
   SQL SELECT col_interval_h_s INTO $sel_interval_h_s FROM lyc_0692 WHERE col_interval_h_s = $ins_interval_h_s END SQL
   ...
   SQL INSERT INTO lyc_0692(col_interval_h9_f) VALUES($ins_interval_h9_f) END SQL
   IF SQLCA.SQLCODE <> 0 THEN DISPLAY "34. SQLCA.SQLCODE = ",SQLCA.SQLCODE END IF
   LET sel_interval_h9_f = NULL
   SQL SELECT col_interval_h9_f INTO $sel_interval_h9_f FROM lyc_0692 WHERE col_interval_h9_f = $ins_interval_h9_f END SQL
